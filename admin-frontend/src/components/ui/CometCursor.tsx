...
export function CometCursor() {
  ...
  return (
    <>
      ...
      >
        <defs>
          <linearGradient id="tail-gradient-admin" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <g ref={tailGroupRef} fill="none" strokeLinecap="round" strokeLinejoin="round">
          <path stroke="url(#tail-gradient-admin)" strokeWidth="6" style={{ opacity: 0, transition: 'stroke-dasharray 0.05s linear' }} />
          <path stroke="url(#tail-gradient-admin)" strokeWidth="3" style={{ opacity: 0, transition: 'stroke-dasharray 0.05s linear' }} />
          <path stroke="url(#tail-gradient-admin)" strokeWidth="1" style={{ opacity: 0, transition: 'stroke-dasharray 0.05s linear' }} />
        </g>
